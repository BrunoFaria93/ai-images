    ...
    <section className="max-w-7xl mx-auto">
      <div>
        ...
        <p className="mt-2 text-slate-200 text-[14px] max-w-[500px]">
          ...
          images generated by DALL-E AI <br /> <br /> Developed by{" "}
          <a href="https://portfolio-brunofaria.vercel.app" className="text-[#6469ff] underline underline-offset-2">Bruno Faria</a>
        </p>
      </div>
